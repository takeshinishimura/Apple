...
1. [MacTeX](https://www.tug.org/mactex/) のインストーラーを使って，インストールしたGhostscriptをアンインストールする。

環境によって異なるが，以下を実行すれば問題なく削除できるはず。
```
...
1. [MacTeX](https://www.tug.org/mactex/) のGhostscriptをアンインストールした後に，Homebrewを使って，Ghostscriptをインストールする。
